...
'''
    ...
    Scrapy run + store: scrapy runspider spider_political_parties.py -o datasets/tse/json/parties.json
'''
import scrapy
import re 
import pandas as pd
...
# from resource_uri.setters import set_slp:resource_uri
...
class TsePoliticalPartiesSpider(scrapy.Spider):
    ...
    def __init__(self,  *args,**kwargs):
        ...
        # Roles dictionary
        # d= pd.read_csv('resource_uri/org:role.csv', sep= ';', index_col=0).to_dict()['skos:prefLabel']
